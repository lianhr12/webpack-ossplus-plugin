...
var WebpackOSSPlusPlugin = /** @class */ (function () {
    function WebpackOSSPlusPlugin(config) {
        ...
        if (typeof provider.aliOSS !== 'undefined') {
            ...
            var config_1 = new qiniu.conf.Config();
            config_1.zone = qiniu.zone.Zone_z2;
            var formUploader = new qiniu.form_up.FormUploader(config_1);
            var putExtra = new qiniu.form_up.PutExtra();
            var bucketManager = new qiniu.rs.BucketManager(mac, config_1);
            this.client = {
    ...
    WebpackOSSPlusPlugin.prototype.pickupAssetsFile = function (compilation) {
        ...
        return map(matched, function (value, name) { return ({
            name: name,
...
function log() {
    ...
    console.log.apply(console, __spreadArray([chalk.bgMagenta('[webpack-cdn-plugin]:')], args, false)); // eslint-disable-line
}
function warn() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
